              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
                  ...
                  >
                      <div className="space-y-8 mb-8 p-4 bg-gray-800 rounded-lg shadow-md">
                          ...
                          <div>
                              <div className="text-2xl text-yellow-500 mb-2">Sales:-</div>
                          ...
                          <div>
                              <div className="text-2xl text-yellow-500 mb-2">Support:-</div>
                          ...
                          <div>
                              <div className="text-2xl text-yellow-500 mb-2">Stay Connected:-</div>
