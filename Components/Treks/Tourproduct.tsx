...
const Tourproduct : FC<TourProps> = ({ data })=> {
   ...
   ₹{data.originalprice}
  ...
  )} <FontAwesomeIcon icon={faIndianRupeeSign} className='text-sm w-4 h-4 ' /><p className='text-[18px]'>{data.amount}</p> </div> )}
            </div>
    ...
    <div className="bg-white md:p-10 p-4 pt-0 md:pt-0 text-black">
        <div className="border-b-2 border-gray-300 md:pb-8 py-1">
            <div className="flex justify-between items-center md:hidden" onClick={() => toggleSection("itinerary")} > 
