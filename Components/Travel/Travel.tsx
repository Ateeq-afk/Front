...
<div className='text-yellow-800 font-extrabold text-2xl '> ₹12,000/-</div>
...
<div>
<p className="text-5xl text-yellow-500 font-semibold">12 </p>
...
LEARN MORE
     ...
     <motion.div className="flex-1 mx-4 text-center z-10"
       ...
       <h2 className="mb-4 text-[18px] text-white">What the journey brings to your life</h2>
...
<div>
<p className="md:text-5xl text-4xl text-yellow-500 font-semibold">12 </p>
 <p className="text-xs text-gray-500">MONTHS VALIDITY</p>
</div>
...
<div className='text-yellow-800 font-extrabold text-2xl '> ₹21,000/- </div>
<div className="space-y-4">
<div className="flex justify-around items-center text-center">
<div className="flex space-x-3">
<div>
...
Learn More
    ...
    <div className="bg-black md:p-10 py-5">
      <div className="max-w-6xl mx-auto rounded-2xl bg-black shadow-md overflow-hidden">
        <div className="md:p-5">
          <div className="md:text-[40px] text-3xl font-bold text-center text-yellow-500">What you get ?</div>
        </div>
    ...
    <div className="absolute top-[25px]  ">
      ...
      <div className="mt-4 text-lg font-semibold">{benefit.title}</div>
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 z-50" onClick={closePopup}>
          <div className="flex justify-center items-center h-full">
            <div className="bg-gradient-to-r from-white to-gray-300 rounded-lg p-5 flex flex-col items-center" onClick={(e) => e.stopPropagation()}>
              ...
              <div className="text-lg font-semibold">{selectedBenefit.title}</div>
    ...
    <div className='text-center md:mt-10 mt-5 '>
        <div className='md:text-[40px] text-3xl ' >Select from 20 Amazing <span className='text-yellow-500 font-bold'>Treks</span> & <span className='text-yellow-500 font-bold'>Tours</span>  </div>
    </div>
  ...
  display: 'inline' 
    ...
    <div className="md:mx-10 mx-4 md:py-10 py-5">
      <div className="flex flex-col md:flex-row items-center  md:space-x-12">
        <div className=" md:flex flex-col  md:w-3/4">
          <div className="md:text-[40px] text-3xl flex justify-center items-center md:block font-bold text-black uppercase md:ml-14 ml-2">
    ...
    <section className="bg-gray-100 md:py-10 md:px-6 pl-4 pr-4 py-5 "id="trek-pass">
        <div className="container mx-auto flex flex-wrap items-center justify-between">
          ...
          <div className="md:text-[40px] text-3xl font-bold text-black mb-4">
